...
from .modules.mrla_light_module import mrla_light_layer
...
class MRLA_Bottleneck(BaseModule):
    expansion = 4
    ...
    def __init__(self, inplanes, planes, 
                 ...
                 init_cfg=None):
        super(MRLA_Bottleneck, self).__init__(init_cfg)
...
class ResNet_mrlal(BaseModule):
    ...
    def __init__(self, 
        ...
        super(ResNet_mrlal, self).__init__(init_cfg)
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
    ...
    def train(self, mode=True):
        ...
        freezed."""
        super(ResNet_mrlal, self).train(mode)
        self._freeze_stages()
