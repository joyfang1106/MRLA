...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='ceit_tiny_patch16_224', type=str, 
                        # choices=model_names,
                        metavar='MODEL',
    ...
    # ceit leff module
    parser.add_argument('--leff-local-size', default=3, type=int,
                        help='Kernel size of depth-wise conv in leff module')
    parser.add_argument('--leff-with-bn', default=True, help='Using batchnorm in leff module')
...
def main(args):
    ...
    model = create_model(
        ...
        leff_local_size=args.leff_local_size,
        leff_with_bn=args.leff_with_bn
    )
...
if __name__ == '__main__':
    ...
    save_path = "%s/%s/"%(args.output_dir, args.model + '_' + args.action)
