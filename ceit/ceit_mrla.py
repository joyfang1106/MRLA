...
__all__ = [
    'ceit_mrla_tiny_patch16_224', 'ceit_mrla_small_patch16_224', 'ceit_mrla_base_patch16_224',
    # 'ceit_mrla_tiny_patch16_384', 'ceit_mrla_small_patch16_384',
]
...
class Block(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, qk_scale=None, 
                 drop=0., attn_drop=0., dim_pergroup=32, 
        ...
        if feedforward_type == 'leff':
            ...
            self.mrla = mrla_module(input_dim=dim)
...
@register_model
def ceit_mrla_tiny_patch16_224(pretrained=False, **kwargs):
    """
...
@register_model
def ceit_mrla_small_patch16_224(pretrained=False, **kwargs):
    """
    convolutional + pooling stem
    local enhanced feedforward
    attention over cls_tokens
...
@register_model
def ceit_mrla_base_patch16_224(pretrained=False, **kwargs):
    """
    convolutional + pooling stem
    local enhanced feedforward
    attention over cls_tokens
